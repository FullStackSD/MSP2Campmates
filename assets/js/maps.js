...
function initMap() {
    ...
    var markerList = [
        {'location': { lat: 53.2951569, lng: -6.1384571 }, 'storeId': 'campworld'},
        {'location': { lat: 53.3925976, lng: -6.068269 }, 'storeId': 'winfieldsoutdoors'},
        {'location': { lat: 53.291892, lng: -6.1350469 }, 'storeId': 'basecamp'},
        {'location': { lat: 53.2941696, lng: -6.133857 }, 'storeId': 'outlandusa'},
    ];
